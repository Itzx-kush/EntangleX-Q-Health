...
test('quantum execution and evidence limits are explicit',()=>{for(const value of [/exact local statevector simulation/i,/not hardware/i,/CV: not executed/i,/Missing metrics remain NA/i,/No winner is inferred automatically/i])assert.match(center,value)});
